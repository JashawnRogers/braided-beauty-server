...
SET booking_open_at = booking_open_date::timestamp + time '00:00'
WHERE booking_open_at IS NULL
  AND booking_open_date IS NOT NULL;

UPDATE schedule_calendar
SET booking_close_at = booking_close_date::timestamp + time '23:59:59'
WHERE booking_close_at IS NULL
  AND booking_close_date IS NOT NULL;
